<template>
  ...
  <div class="popup-inner">
    ...
    <div>
      ...
      <input class="upload mb-3" accept="image/*" type="file" placeholder="Choose image" multiple @change="onSelectedFiles($event.target.files)">
    </div>
    <div class="buttons">
...
export default {
  ...
  methods: {
    ...
    async add () {
      ...
      await this.$resource.resource(1, '/item', fd)
